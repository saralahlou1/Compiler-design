...
\begin{mathpar}
    \inferrule*[left=FunProto(\textup{f})]{\ }{add\ \langle f: (U_1, \ldots, U_n) \rightarrow \textbf{T} \rangle\ to\ \Gamma}
\and
...
% FieldAccessExpr
\begin{mathpar}
\inferrule*[left={FieldAccessExpr(\textup{e,fieldName})}]{\Gamma \vdash e : \textbf{StructType}_{fieldName : \textbf{T}}}{\Gamma \vdash e.fieldName : \textbf{T} }
\end{mathpar}
...
%\begin{mathpar}
%    \inferrule*[left=Continue]{\ }{\ }
%    \and
%    \inferrule*[left=Break]{\ }{\ }
%\end{mathpar}
