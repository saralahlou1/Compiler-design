...
5. [Part 5 (object-oriented features)](parts/part5/): Friday 26 April 2024, at 5pm, weight = 20%
...
This plagiarism detection software is able to identify similarities at a structural level.
...
Also please make sure to keep `comp520-coursework-w2024` as your repository name, otherwise the automarker will fail and you will receive a zero.
...
* To clone the repository via SSH you should ensure that you've uploaded a public key to GitLab, launch a terminal, and type:
  ```
  $ git clone git@gitlab.cs.mcgill.ca:XXXXXXXX/comp520-coursework-w2024.git
  ```
...
* To clone the repository via HTTPS you should launch a terminal and type:
  ```
  $ git clone https://gitlab.cs.mcgill.ca/XXXXXXXX/comp520-coursework-w2024.git
  ```
