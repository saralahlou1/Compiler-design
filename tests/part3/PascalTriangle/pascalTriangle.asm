...
# Original instruction: syscall
syscall
# Original instruction: li v43,10
li $t5,10
la $t0,label_135_v43
sw $t5,0($t0)
...
# Original instruction: syscall
syscall
# Original instruction: addi v44,$fp,-8
addi $t5,$fp,-8
la $t0,label_140_v44
sw $t5,0($t0)
...
la $t0,label_141_v46
sw $t5,0($t0)
# Original instruction: add v45,v44,v46
la $t5,label_140_v44
lw $t5,0($t5)
la $t4,label_141_v46
lw $t4,0($t4)
...
la $t0,label_145_v47
sw $t5,0($t0)
# Original instruction: sw v45,0(v47)
la $t5,label_144_v45
lw $t5,0($t5)
la $t4,label_145_v47
lw $t4,0($t4)
...
# Original instruction: addi v51,$sp,0
addi $t5,$sp,0
la $t0,label_154_v51
sw $t5,0($t0)
# Original instruction: addi $sp,$sp,4
