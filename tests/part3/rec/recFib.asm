...
la $t0,label_54_v15
sw $t4,0($t0)
# Original instruction: addi v16,$fp,-32
addi $t5,$fp,-32
la $t0,label_55_v16
sw $t5,0($t0)
...
la $t0,label_68_v20
sw $t4,0($t0)
# Original instruction: addi v21,$fp,-36
addi $t5,$fp,-36
la $t0,label_69_v21
sw $t5,0($t0)
...
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addi v22,$fp,-32
addi $t5,$fp,-32
la $t0,label_76_v22
sw $t5,0($t0)
...
la $t0,label_77_v24
sw $t4,0($t0)
# Original instruction: add v23,v22,v24
la $t5,label_76_v22
lw $t5,0($t5)
la $t4,label_77_v24
lw $t4,0($t4)
...
la $t0,label_79_v23
sw $t3,0($t0)
# Original instruction: sw v23,4($fp)
la $t5,label_79_v23
lw $t5,0($t5)
sw $t5,4($fp)
