...
la $t0,label_11_v0
sw $t5,0($t0)
# Original instruction: addi v1,$fp,-40
addi $t5,$fp,-40
la $t0,label_12_v1
sw $t5,0($t0)
...
la $t0,label_23_v5
sw $t5,0($t0)
# Original instruction: addi v6,$fp,-40
addi $t5,$fp,-40
la $t0,label_24_v6
sw $t5,0($t0)
...
la $t0,label_35_v10
sw $t5,0($t0)
# Original instruction: addi v11,$fp,-40
addi $t5,$fp,-40
la $t0,label_36_v11
sw $t5,0($t0)
...
lw $t4,0($t4)
sw $t5,0($t4)
# Original instruction: addi v15,$fp,-40
addi $t5,$fp,-40
la $t0,label_46_v15
sw $t5,0($t0)
...
# Original instruction: syscall
syscall
# Original instruction: addi v25,$fp,-40
addi $t5,$fp,-40
la $t0,label_70_v25
sw $t5,0($t0)
